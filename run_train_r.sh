...
do
	...
	do
	    python $work_dir/$code_dir/thumt/bin/trainer.py \
	      --model rnnsearch \
	      --output $work_dir/r_agdt-result-$idx \
	      --input $train_dir/atsa_train_14_r.txt \
	      --vocabulary $train_dir/vocab_cs_14_r.txt $train_dir/vocab_aspect_14_r.txt $train_dir/vocab_target.txt $train_dir/vocab_flag.txt $train_dir/vocab.c \
	      --evaluation $train_dir/atsa_test_14_r_flag.txt \
