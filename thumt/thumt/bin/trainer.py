...
def parse_args(args=None):
    ...
    parser.add_argument("--vocabulary", type=str, nargs="+",
                        help="Path of source, aspect flag and target vocabulary")
    parser.add_argument("--evaluation", type=str, 
                        help="Path of evaluation file")
...
def default_parameters():
    params = tf.contrib.training.HParams(
        ...
        train_path="",
        evaluation_path="",
        embedding_path="/home1/lyl/embedding/glove.840B.300d.part1.txt",
        flag="for what",
        ...
        use_prediction=True,
        use_aspect=True,
        use_aspect_gate=True,
        use_capsule_net=False,
...
def override_parameters(params, args):
    ...
    params.evaluation = args.evaluation or params.evaluation
    params.references = args.references or params.references
    params.parse(args.parameters)

    params.vocabulary = {
        "source": vocabulary.load_vocabulary(params.vocab[0]),
        "aspect_word": vocabulary.load_vocabulary(params.vocab[1]),
        "target": vocabulary.load_vocabulary(params.vocab[2]),
        "flag": vocabulary.load_vocabulary(params.vocab[3]),
        "char": vocabulary.load_vocabulary(params.vocab[4])
    }
    params.vocabulary["source"] = vocabulary.process_vocabulary(
        params.vocabulary["source"], params
    )
    params.vocabulary["aspect_word"] = vocabulary.process_vocabulary(
        params.vocabulary["aspect_word"], params
    )
    params.vocabulary["target"] = vocabulary.process_vocabulary(
        params.vocabulary["target"], params
    )
    params.vocabulary["flag"] = vocabulary.process_vocabulary(
        params.vocabulary["flag"], params
    )
    ...
    params.mapping = {
        ...
        "aspect_word": vocabulary.get_control_mapping(
            params.vocabulary["aspect_word"],
            control_symbols
        ),
        ...
        "flag": vocabulary.get_control_mapping(
            params.vocabulary["flag"],
            control_symbols
        ),
...
def get_learning_rate_decay(learning_rate, global_step, params):
    if params.learning_rate_decay == "noam":
        ...
        return tf.maximum(learning_rate * decay, 5e-5)
            ...
            tf.train.LoggingTensorHook(
                {
                    ...
                    "aspect_word": tf.shape(features["aspect_word"]),
                    "char": tf.shape(features["chars"]),
